      ...
      <header className="docked full-width top-0 no-border flat no shadows z-50 bg-[#0A0B0D]">
        <div className="flex justify-between items-center w-full px-8 md:px-12 py-6 md:py-8 max-w-[1920px] mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:flex items-center gap-2 px-5 py-2.5 bg-primary text-on-primary rounded-xl font-bold text-sm tracking-wide uppercase hover:opacity-90 transition-opacity">
              Connect Wallet
            </button>
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-6 relative z-10 w-full max-w-[1920px] mx-auto">
        <div className="w-full max-w-[440px] flex flex-col items-center text-center space-y-10 animate-fade-in">
          ...
          <div className="w-full space-y-4">
            ...
            <Link href="/vault" className="w-full h-[52px] bg-primary text-on-primary font-bold text-[15px] uppercase tracking-wide rounded-[12px] flex items-center justify-center gap-2 hover:opacity-90 transition-opacity bg-gradient-to-b from-primary to-primary-container shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
